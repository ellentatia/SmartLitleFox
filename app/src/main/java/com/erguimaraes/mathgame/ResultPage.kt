...
fun ResultPage(navController: NavController, score: Int) {
    ...
    systemUIController.setSystemBarsColor(colorResource(id = R.color.ice_blue))
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .paint(
                painterResource(id = R.drawable.thirdpage),
        ...
        Text(text = "Your score: $score", color = Color.Red, fontSize = 24.sp)
